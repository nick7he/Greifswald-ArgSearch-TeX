...
\begin{document}
	...
	\begin{frame}{ArgumenText}
		\begin{itemize}
			...
			\item Erst Retrieval ganzer Dokumente, anschließend Extraktion der Argumente durch neuronales Netz
		\end{itemize}
		~\\
	...
	\begin{frame}{Die ideale Argumentsuchmaschine}{Ideensammlung}
